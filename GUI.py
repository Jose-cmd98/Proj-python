...
class Gui():
    ...
    lblnome = Label(window, text="Nome", font="Arial 13")


    lblsobrenome = Label(window, text="Sobrenome", font="Arial 13")


    lblemail = Label(window, text="Email", font="Arial 13")


    lblcpf = Label(window, text="CPF", font="Arial 13")
